...
const integrations = [
  {
    ...
    logo: 'https://videotosfx.elevenlabs.io/icon.ico',
    status: 'beta',
    category: 'AI Voice',
  },
  {
  ...
  },
  {
    ...
    logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQBlzmkasmPrb4zqCsBeoPeOqiG_kYwasCOEA&s',
    status: 'alpha',
  ...
  },
  {
    ...
    logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQVRSNCZKUcvSYkmDLtSNNaRwRDh8rz5HxHA&s',
    status: 'enabled',
    category: 'LLM',
  },
  {
    ...
    logo: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQLt5RQx6V1W6XXJcczgwNbzbdGyfHNCYtSCQ&s',
    status: 'enabled',
    category: 'Database',
  },
  {
